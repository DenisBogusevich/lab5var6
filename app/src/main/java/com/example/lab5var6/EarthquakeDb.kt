...
class EarthquakeDatabaseHelper(context: Context) :
    ...
    fun insertEarthquake(earthquake: EarthquakeProperties) {
    ...
    fun isEarthquakeExists(earthquake: EarthquakeProperties): Boolean {
    ...
    fun getAllEarthquakes(): List<EarthquakeProperties> {
        val db = readableDatabase
        val earthquakes = mutableListOf<EarthquakeProperties>()
        ...
        with(cursor) {
            while (moveToNext()) {
                ...
                earthquakes.add(EarthquakeProperties(place, time))
            }
        }
        cursor.close()
        return earthquakes
